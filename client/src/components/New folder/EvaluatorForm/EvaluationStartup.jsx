...
const EvaluationStartup = () => {
  ...
  const handleExport = () => {
    ...
    const csv = selectedStartups.map((startup) => ({
      ...
      "Registered Office Location":
        ...
        startup.formData["RegisteredOfficeLocation"],
      "One Line of Your Startup":
        startup.formData["One Liner of your startup"] ||
        startup.formData["OneLinerOfYourStartup"],
      Logo:
        startup.files.find((file) => file.mimeType.startsWith("image/"))
          ?.originalName || "",
      "Social Media Link":
        startup.formData["Social Media Link"] ||
        startup.formData["SocialMediaLink"],
      "Domain Of Startup":
        startup.formData["Domain Of Startup"] ||
        startup.formData["DomainOfStartup"],
      "Team Size":
        startup.formData["Startup team size"] ||
        startup.formData["StartupTeamSize"],
    }));
  ...
  const handleViewDetails = (startup) => {
    navigate(`/evaluation-startup/${startup.formTitle}`, {
      state: { startup },
    });
  };
    ...
    <div className="dashboard-form-evaluationstartup">
        ...
        <div className="logo-container-evaluationstartup">
          <div className="logo-evaluationstartup">
            <img
              ...
              alt="Logo"
              className="dristilogo-evaluationstartup"
            />
          </div>
        </div>
        <div className="nav-container-evaluationstartup">
          <nav className="nav-evaluationstartup">
            <ul>
              <li>
                <Link to="/form">
                  <CgNotes className="nav-icon-evaluationstartup" /> General
                  Form
                </Link>
              </li>
              <li>
                <Link to="/evaluation-startup">
                  <AiOutlineEye className="nav-icon-evaluationstartup" />{" "}
                  Evaluator Form
                </Link>
              </li>
            </ul>
      ...
      <main className="main-content-form-evaluationstartup">
        ...
        <header className="header-form-evaluationstartup">
          <span className="founder-form-evaluationstartup">All Forms</span>
          <div className="profile-section-form-evaluationstartup">
            ...
            <div className="user-info-form-evaluationstartup">
              ...
              <span className="user-initials-form-evaluationstartup">
                <img
              ...
              <div className="user-details-form-evaluationstartup">
                ...
                <br />
                <span className="user-email-form-evaluationstartup">
                  {user.email}
                </span>
                {/* HIGHLIGHT END */}
              </div>
          ...
          <div className="form-list-form-evaluationstartup">
            <div className="search-container-new-evaluationstartup">
              <input
                ...
                className="search-bar-small-new-evaluationstartup"
              />
              <button className="view-startup-button-new-evaluationstartup">
                View Startup
              </button>
            </div>
            <div className="table-container-new-evaluationstartup">
                  ...
                  <thead>
                    <tr>
                      ...
                      <th onClick={() => requestSort("Name")}>
                        Startup Name{" "}
                        <span className="sort-icon-evaluationstartup">
                      ...
                      <th
                        onClick={() =>
                          requestSort("Registered Office Location")
                        }
                      >
                        Registered Office Location{" "}
                        <span className="sort-icon-evaluationstartup">
                          {getClassNamesFor("Registered Office Location") ===
                          "ascending" ? (
                            <SortAscIcon />
                          ) : getClassNamesFor("Registered Office Location") ===
                            "descending" ? (
                      ...
                      <th
                        onClick={() => requestSort("One Liner of your startup")}
                      >
                        One Line of Your Startup{" "}
                        <span className="sort-icon-evaluationstartup">
                          {getClassNamesFor("One Liner of your startup") ===
                          "ascending" ? (
                            <SortAscIcon />
                          ) : getClassNamesFor("One Liner of your startup") ===
                            "descending" ? (
                      ...
                      <th onClick={() => requestSort("Domain Of Startup")}>
                        Domain Of Startup{" "}
                        <span className="sort-icon-evaluationstartup">
                          {getClassNamesFor("Domain Of Startup") ===
                          "ascending" ? (
                            <SortAscIcon />
                          ) : getClassNamesFor("Domain Of Startup") ===
                            "descending" ? (
                      ...
                      <th onClick={() => requestSort("Startup team size")}>
                        Team Size{" "}
                        <span className="sort-icon-evaluationstartup">
                          {getClassNamesFor("Startup team size") ===
                          "ascending" ? (
                            <SortAscIcon />
                          ) : getClassNamesFor("Startup team size") ===
                            "descending" ? (
                  ...
                  <tbody>
                    {currentStartups.length === 0 ? (
                      <tr>
                        <td
                          colSpan="10"
                          className="no-evaluation-evaluationstartup"
                        >
                          <div className="no-evaluation-content-evaluationstartup">
                            <img
                              src="/founders/nostartupadd.jpg"
                              alt="Logo"
                              style={{
                                marginTop: "70px",
                                width: "120px",
                        ...
                        <tr key={index}>
                          ...
                          <td>
                            <div className="action-column-evaluationstartup">
                              <AiOutlineEye
                                className="view-icon-new-evaluationstartup"
              ...
              <div className="pagination-container-new-evaluationstartup">
                <div className="pagination-new-evaluationstartup">
                  <FaChevronLeft
                    className={`pagination-arrow-new-evaluationstartup ${
                      currentPage === 1 && "disabled"
                    }`}
                    onClick={() => handlePageChange(currentPage - 1)}
                  />
                  <span className="page-number-new-evaluationstartup">
                    <span className="current-page-new-evaluationstartup">
                      {currentPage}
                    </span>{" "}
                    / {totalPages}
                  </span>
                ...
                <div className="exporttablepage-new-evaluationstartup">
                  <div
                    className="export-table-new-evaluationstartup"
